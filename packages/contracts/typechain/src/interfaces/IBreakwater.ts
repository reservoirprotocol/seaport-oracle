...
export interface IBreakwaterInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "setSigner" | "signer" | "validateOrder"
  ): FunctionFragment;
...
export interface IBreakwater extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBreakwaterInterface;
